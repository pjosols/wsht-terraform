...
module "kms" {
  source = "git::https://github.com/pjosols/wsht-terraform.git//modules/kms?ref=v1.10.1"
...
module "apigw" {
  source = "git::https://github.com/pjosols/wsht-terraform.git//modules/apigw?ref=v1.10.1"
...
module "monitoring" {
  source = "git::https://github.com/pjosols/wsht-terraform.git//modules/monitoring?ref=v1.10.1"
